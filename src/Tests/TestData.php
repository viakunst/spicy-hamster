...
class TestData
{
     ...
     */
    public static function create(Type $type = null): TestData
    {
        if (is_null($type)) {
            return new TestData([]);
        }
     ...
     *
     * @param array<array<mixed>>|null $set
     *
     * @return array<array<mixed>> Cartesian product of arrays
     */
    protected static function cartesian($set)
    {
        if (null == $set) {
            return [[]];
        }
     ...
     * @var array<callable>
     */
    protected array $action_options;
    ...
    /**
     * @param array<mixed>|object $initial
     */
     ...
     * @return array<object>
     */
    protected function buildPermutations()
    {
     ...
     */
    protected function allConditionsSucceed(object $object): bool
    {
