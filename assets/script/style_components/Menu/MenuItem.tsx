...
import { isValidElement, cloneElement } from '../Util/ReactNode';
...
export default class MenuItem extends React.Component<MenuItemProps> {
  ...
  renderItem = ({ siderCollapsed }: SiderContextProps) => {
    const {
      prefixCls, firstLevel, inlineCollapsed, direction, disableMenuItemTitleTooltip,
    } = this.context;
    const { className, children } = this.props;
    const {
      title, icon, danger, ...rest
    } = this.props;
