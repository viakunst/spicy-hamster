 ...
 */
final class Version20220323200543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', transaction_group_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', account VARCHAR(255) NOT NULL, voltooid TINYINT(1) NOT NULL, opmerking VARCHAR(255) DEFAULT NULL, INDEX IDX_723705D1B026F02F (transaction_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
