...
final class Version20220327152610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statement (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) NOT NULL, iban VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, item VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, `group` LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', comment LONGTEXT NOT NULL, feedback LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, amount INT NOT NULL, image_name VARCHAR(255) NOT NULL, image_size INT NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
